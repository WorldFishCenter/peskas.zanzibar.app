        ...
        <div className="grid cursor-pointer grid-cols-1 gap-1 ps-4">
          {notificationsData.map((item) => (
            <div
              ...
              className="group grid grid-cols-[auto_minmax(0,1fr)] gap-3 rounded-md px-2 py-2 pe-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700/50"
            >
              <div className="flex h-9 w-9 items-center justify-center rounded bg-gray-100/70 p-1 dark:bg-gray-900/50 [&>svg]:h-auto [&>svg]:w-5">
                <item.icon />
              </div>
...
export default function NotificationDropdown({
  ...
  return (
    ...
    >
      ...
      <Popover.Content className="z-[9999] px-0 pb-4 pe-6 pt-5 rounded-xl shadow-xl border border-gray-200 bg-gray-0/95 backdrop-blur-md [&>svg]:hidden [&>svg]:dark:fill-gray-100 sm:[&>svg]:inline-flex">
