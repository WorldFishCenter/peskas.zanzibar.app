...
export default function DistrictRanking({
  ...
  // Determine which district to use for highlighting - simplified for Zanzibar
    ...
    try {
      ...
      const rankingData: BMURankingData[] = Object.entries(bmuAverages)
        .map(([bmuName, data]) => ({
          ...
          fill: generateColor(0, bmuName, effectiveDistrict),
  ...
  }, [rawData, selectedMetric, effectiveDistrict, hasRestrictedAccess, getAccessibleBMUs, safeBmus, rankingData.length, loading]);
