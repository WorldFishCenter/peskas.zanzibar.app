...
import { convertCase } from "../utils/common/functions";
import { Case } from "../utils/common/enums"
...
const LinkCell = <T,>(
  params: React.DetailedHTMLProps<
    ...
    HTMLAnchorElement
  > &
    Partial<CellContext<T, string | number>> & { href: string },
) => {
  return (
    <div className="ml-4 flex items-center">
      <a
        href={params.href}
        className="font-semibold text-[#2a846f] underline"
        onClick={(e) => {
          // So that clicking the link doesn't do the onClick row action
          e.stopPropagation();
        }}
      >
        {params.children ?? params.getValue?.()}
